...
\begin{figure}
\centering
\includegraphics{lolog_catalog_files/figure-latex/unnamed-chunk-7-1.pdf}
\caption{\label{fig:sailer_gof_gwesp_star_ideg}In-degree goodness of fit
comparison plot for Sailer's office layout networks. The comparison is
between the published ERGM and LOLOG fits with GWESP and stars terms
included.}
\end{figure}
