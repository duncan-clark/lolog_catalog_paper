...
See \url{https://github.com/duncan-clark/lolog_catalog_paper} for example R code for fitting LOLOG models and ERGM. 
...
of how far the desks could be perceived to be apart given the topography of the office (See \cite{Sailer2012} for precise definitions). 
